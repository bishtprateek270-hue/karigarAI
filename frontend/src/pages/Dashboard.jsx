    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            <span style={{ background: 'rgba(255,255,255,0.2)', padding: '4px 12px', borderRadius: '20px', fontSize: '0.82rem', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
              Artisan Creator Portal
            </span>
            <h1 style={{ fontSize: '2.2rem', marginTop: '8px', color: '#fff' }}>Namaste, {user?.name}! 🙏</h1>
      ...
      <div className="grid-3">
        <div className="card" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            <div style={{ fontSize: '0.88rem', color: 'var(--text-muted)', fontWeight: '600' }}>Total Products</div>
        ...
        <div className="card" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            <div style={{ fontSize: '0.88rem', color: 'var(--text-muted)', fontWeight: '600' }}>Published Products</div>
        ...
        <div className="card" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            <div style={{ fontSize: '0.88rem', color: 'var(--text-muted)', fontWeight: '600' }}>Draft Listings</div>
      ...
      <div className="card">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <h3 style={{ fontSize: '1.3rem' }}>Recent Artisan Products</h3>
          ...
          <div className="grid-3">
            {products.slice(0, 3).map((p) => (
              <div key={p.id} className="card" style={{ padding: '16px', background: '#fff', border: '1px solid var(--border-color)' }}>
                ...
                <h4 style={{ fontSize: '1rem', marginBottom: '6px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{p.title}</h4>
                <p style={{ fontSize: '0.82rem', color: 'var(--text-muted)', marginBottom: '12px' }}>{p.category || 'General Craft'}</p>
